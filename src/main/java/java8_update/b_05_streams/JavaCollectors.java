...
import java8_update.b_05_streams.tasks.Dish;
import java8_update.b_05_streams.tasks.DishData;
...
public class JavaCollectors {
    public static void main(String[] args) {
        ...
        Long evenCount2 = numbers.stream()  // same with above
                .filter(x -> x % 2 == 0)
                .count();
        ...
        Integer sum2 = DishData.getAll().stream()
       ...
       Double calorieAvg =  DishData.getAll().stream()
        ...
        String str2 = String.join(",", courses);    // same with above
