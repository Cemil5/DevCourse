...
@Component
public class PracticeWithAnswers {
    ...
    public PracticeWithAnswers(CountryService countryService, DepartmentService departmentService,
                               EmployeeService employeeService, JobHistoryService jobHistoryService,
                               JobService jobService, LocationService locationService,
                               RegionService regionService) {

        PracticeWithAnswers.countryService = countryService;
        PracticeWithAnswers.departmentService = departmentService;
        PracticeWithAnswers.employeeService = employeeService;
        PracticeWithAnswers.jobHistoryService = jobHistoryService;
        PracticeWithAnswers.jobService = jobService;
        PracticeWithAnswers.locationService = locationService;
        PracticeWithAnswers.regionService = regionService;
