...
public class PracticeTest {
    ...
    public void shouldGetMaxSalaryEmployeeJob() throws Exception {
        List<Job> jobs = Practice.getMaxSalaryEmployeeJob();
        Assert.assertEquals("President", jobs.get(0).getJobTitle());
        Assert.assertEquals("AD_PRES", jobs.get(0).getId());
    }
    ...
    public void shouldGetAverageSalary(){
        ...
        double expectedAverageSalary = 6576.785046728972;
    ...
    public void shouldGetEmployeeWhoseFirstNameIsAlyssaAndManagersFirstNameIsEleniAndDepartmentNameIsSales() throws Exception {
        List<Employee> employee = Practice.getEmployeeWhoseFirstNameIsAlyssaAndManagersFirstNameIsEleniAndDepartmentNameIsSales();
